...
Além da verificação visual, a suíte de 31 testes passou integralmente. Ela cobre sessão e logout, permissões administrativas, limites de domínio para inscrições, projetos, interesses, reuniões e isolamento do ambiente demonstrativo.
