...
type ItemInteresse = {
  ...
  meeting: { scheduledFor: Date; location: string; resource: string; durationMinutes: number } | null;
};
...
export default function LancadorPainel({ onTrocarPapel, modoVisualizacao = false, modoOperacaoAdmin = false }: { onTrocarPapel: (p: "admin" | "expert" | "lancador") => void; modoVisualizacao?: boolean; modoOperacaoAdmin?: boolean }) {
  ...
  const reunioesValidacao = trpc.interests.validationMineAsLauncher.useQuery(undefined, { retry: false, enabled: modoOperacaoAdmin });
