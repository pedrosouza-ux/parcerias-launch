...
export default function LancadorPainel({ onTrocarPapel, modoVisualizacao = false, modoOperacaoAdmin = false }: { onTrocarPapel: (p: "admin" | "expert" | "lancador") => void; modoVisualizacao?: boolean; modoOperacaoAdmin?: boolean }) {
  ...
  return <PainelLayout papel="lancador" onTrocarPapel={onTrocarPapel} nomeUsuario={modoVisualizacao ? "Administrador" : modoOperacaoAdmin ? "Demonstração Lançador 01" : "Lançador"} paginaAtiva={pagina} onNavegar={setPagina} modoVisualizacao={modoVisualizacao}
